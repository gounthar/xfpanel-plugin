...
public class XFPanelEntryTest {
    ...
    public void testJobNameReplaced() throws Exception {
        ...
        XFPanelView view = PowerMock.createPartialMock(
                XFPanelView.class, "getJobNameReplaceRegExp", "getJobNameReplacement", "getShowDescription");
        EasyMock.expect(view.getJobNameReplaceRegExp())
                .andReturn(jobNameReplaceRegExp)
                .anyTimes();
        EasyMock.expect(view.getJobNameReplacement())
                .andReturn(jobNameReplacement)
                .anyTimes();
    ...
    private XFPanelEntry prepareData(int allFailed, boolean oneClaimed, boolean showClaimed)
        ...
        EasyMock.expect(view.getReplaceNumberOfTestCases())
                .andReturn(showClaimed)
                .anyTimes();
        ...
        EasyMock.expect(jenkins.getPlugin("claim"))
                .andReturn(new Plugin.DummyImpl())
                .anyTimes();
